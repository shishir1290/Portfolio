...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white p-4 lg:p-6 fixed bottom-0 left-0 w-full z-50">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-4">
        {/* Contact Information */}
        <div className="text-center lg:text-left">
          ...
          <div className="text-sm lg:text-base mt-1 flex items-center justify-center lg:justify-start space-x-3">
            <FaEnvelope />
            <Link
        ...
        {/* Social Media Links */}
        <div className="flex flex-wrap justify-center lg:justify-end gap-6 text-lg">
          <Link
